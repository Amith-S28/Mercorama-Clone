...
const CSL_FALLBACK_ENTRIES: {
  ...
  },
  {
    ...
    source: "SEMA/CSL",
    aliases: ["IRGC", "REVOLUTIONARY GUARD"],
  },
  {
    name: "NORTH KOREA MINING DEVELOPMENT TRADING",
    source: "SEMA/CSL",
    aliases: ["KOMID", "MINING DEVELOPMENT TRADING"],
  },
  {
    name: "SYRIAN PETROLEUM COMPANY",
    source: "SEMA/CSL",
    aliases: ["SPC", "SYRIAN PETROLEUM"],
  },
  {
    name: "MYANMAR ECONOMIC HOLDINGS LIMITED",
    source: "SEMA/CSL",
    aliases: ["MEHL", "MYANMAR ECONOMIC HOLDINGS"],
  },
];
...
function matchesEntry(
  normalized: string,
  entry: (typeof CSL_FALLBACK_ENTRIES)[number],
): boolean {
