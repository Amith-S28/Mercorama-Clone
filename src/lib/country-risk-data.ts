...
export const COUNTRY_RISK_DATA: CountryRiskEntry[] = [
  {
    ...
    tier: "open",
    fta: "CUSMA",
    ftaNotes: "Canada-United States-Mexico Agreement",
  ...
  },
  {
    ...
    tier: "open",
    fta: "CUKTCA",
    ftaNotes: "Canada-UK Trade Continuity Agreement",
    region: "europe",
    source: EDC_SOURCE,
  },
  {
    ...
    tier: "open",
    fta: "CETA",
    ftaNotes: "Comprehensive Economic and Trade Agreement (EU)",
    region: "europe",
    source: EDC_SOURCE,
  },
  {
  ...
  },
  {
    ...
    tier: "open",
    fta: "CKFTA",
    ftaNotes: "Canada-Korea Free Trade Agreement",
    region: "asia-pacific",
    source: EDC_SOURCE,
  },
  {
  ...
  },
  {
    ...
    tier: "watch",
    fta: null,
    ftaNotes: "No comprehensive FTA with Canada",
    region: "asia-pacific",
    source: EDC_SOURCE,
  },
  {
  ...
  },
  {
    ...
    tier: "open",
    fta: "CCFTA",
    ftaNotes: "Canada-Chile Free Trade Agreement",
    region: "south-america",
    source: EDC_SOURCE,
  },
  {
  ...
  },
  {
    ...
    tier: "restricted",
    fta: null,
    ftaNotes: "SEMA sanctions active",
    region: "europe",
    source: EDC_SOURCE,
  },
  {
...
export function getRiskTierForNumericId(
  numId: string,
): CountryRiskEntry["tier"] {
  if (numId === CANADA_NUM_ID) return "open";
  const entry = COUNTRY_RISK_DATA.find((c) => ISO3_TO_NUM[c.iso3] === numId);
  return entry?.tier ?? "no-data";
}

export function getCountryForNumericId(
  numId: string,
): CountryRiskEntry | undefined {
