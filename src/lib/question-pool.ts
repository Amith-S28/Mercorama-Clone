...
export const QUESTION_POOL: Question[] = [
  ...
  q(
    "Q1.1",
    "management",
    "How does your organization allocate time and resources to international sales development?",
    [
    ...
    "TCS Step-by-Step Guide to Exporting, BDC Export Readiness Framework",
    "Reactionary exporter syndrome — per BDC research, SMEs that treat exports as overflow fail within 18 months.",
  ),
  q(
    "Q1.2",
    "management",
    "Your board/ownership group asks: 'When should we expect positive ROI from our export initiative?' What is your answer?",
    [
  ...
  q(
    "Q1.3",
    "management",
    "How do you handle the risk of your key export champion leaving the organization?",
    [
  ...
  q(
    "Q1.4",
    "management",
    "A potential distributor in Germany requests a meeting at Anuga. How does management respond?",
    [
  ...
  q(
    "Q1.5",
    "management",
    "How would you describe your formal export plan?",
    [
  ...
  q(
    "Q2.1",
    "product",
    "How have you validated that your product has demand in your target export market?",
    [
  ...
  q(
    "Q2.2",
    "product",
    "Do you know the 6-digit HS (Harmonized System) code for your primary export product?",
    [
  ...
  q(
    "Q2.3",
    "product",
    "Has your product received any international certifications, quality marks, or compliance testing?",
    [
  ...
  q(
    "Q2.4",
    "product",
    "Your Japanese buyer requests bilingual labeling per Japan's Food Sanitation Act. What is your response?",
    [
  ...
  q(
    "Q2.5",
    "product",
    "How do you protect your brand name and product designs in foreign markets?",
    [
  ...
  q(
    "Q3.1",
    "operations",
    "Your German distributor places an unexpected rush order for 200% of your normal monthly output. How does your facility respond?",
    [
  ...
  q(
    "Q3.2",
    "operations",
    "Under which Incoterms 2020 trade terms do you intend to sell to foreign B2B buyers?",
    [
  ...
  q(
    "Q3.3",
    "operations",
    "How do you currently track international orders, shipments, and customs documentation?",
    [
  ...
  q(
    "Q3.4",
    "operations",
    "How will you handle the physical packaging requirements for international ocean freight?",
    [
  ...
  q(
    "Q3.5",
    "operations",
    "Your cargo ship to Hamburg has been delayed by 3 weeks due to port congestion. What is your contingency?",
    [
  ...
  q(
    "Q4.1",
    "financial",
    "How will you manage accounts receivable and payment risk with a new foreign buyer?",
    [
  ...
  q(
    "Q4.2",
    "financial",
    "Your target market operates in JPY. How do you plan to handle currency exchange risk on a $500,000 contract?",
    [
  ...
  q(
    "Q4.3",
    "financial",
    "Are you aware of government funding programs that can offset export market entry costs?",
    [
  ...
  q(
    "Q4.4",
    "financial",
    "How have you determined the selling price for your product in the target export market?",
    [
  ...
  q(
    "Q4.5",
    "financial",
    "What is your plan if your first export shipment results in a net financial loss?",
    [
  ...
  q(
    "Q5.1",
    "legal",
    "How will you prepare your packaging and labeling for regulatory compliance in foreign markets?",
    [
  ...
  q(
    "Q5.2",
    "legal",
    "Are you familiar with the export controls and permit requirements that apply to your products?",
    [
  ...
  q(
    "Q5.3",
    "legal",
    "Your product requires a phytosanitary certificate for export to the EU. How do you obtain this?",
    [
  ...
  q(
    "Q5.4",
    "legal",
    "How do you ensure your foreign buyer is not on a sanctions list?",
    [
  ...
  q(
    "Q5.5",
    "legal",
    "What is your understanding of Rules of Origin requirements under CETA for your product?",
    [
  ...
  q(
    "Q6.1",
    "market",
    "How did you select your target export market(s)?",
    [
  ...
  q(
    "Q6.2",
    "market",
    "Can you name your top 3 competitors in your target export market, including local producers?",
    [
  ...
  q(
    "Q6.3",
    "market",
    "How do you plan to find qualified buyers or distributors in your target market?",
    [
  ...
  q(
    "Q6.4",
    "market",
    "What is the average market price for products similar to yours in your target country?",
    [
  ...
  q(
    "Q6.5",
    "market",
    "Do you know which Free Trade Agreements Canada has that provide tariff advantages for your product?",
    [
  ...
  q(
    "Q7.1",
    "cultural",
    "How have you adapted your sales and marketing materials for the target market?",
    [
  ...
  q(
    "Q7.2",
    "cultural",
    "How familiar are you with the business negotiation culture in your target market?",
    [
  ...
  q(
    "Q7.3",
    "cultural",
    "Your Japanese distributor is unresponsive for 3 weeks after your initial product pitch. What do you do?",
    [
  ...
  q(
    "Q7.4",
    "cultural",
    "How do you plan to build long-term customer relationships in your target market?",
    [
  ...
  q(
    "Q7.5",
    "cultural",
    "How does your digital presence address international buyers?",
    [
  ...
  q(
    "Q8.1",
    "digital",
    "Can your internal systems generate documentation required for international shipments?",
    [
  ...
  q(
    "Q8.2",
    "digital",
    "Do you have an e-commerce capability for international B2B or B2C sales?",
    [
  ...
  q(
    "Q8.3",
    "digital",
    "How do you manage and protect sensitive trade documentation digitally?",
    [
  ...
  q(
    "Q8.4",
    "digital",
    "How do you track and analyze the performance of your export operations?",
    [
  ...
  q(
    "Q8.5",
    "digital",
    "Can your website and digital platforms handle inquiries from multiple time zones?",
    [
  ...
  q(
    "Q9.1",
    "programs",
    "Which government export support organizations are you currently engaged with?",
    [
  ...
  q(
    "Q9.2",
    "programs",
    "Have you applied for or received any export-related government funding?",
    [
  ...
  q(
    "Q9.3",
    "programs",
    "Do you have access to export credit insurance to protect against foreign buyer non-payment?",
    [
  ...
  q(
    "Q9.4",
    "programs",
    "Are you a member of any industry trade associations with international trade programs?",
    [
  ...
  q(
    "Q9.5",
    "programs",
    "Have you engaged a customs broker licensed by CBSA to handle your export documentation?",
    [
...
export function selectAssessmentQuestions(seed = 42): string[] {
  ...
  const remaining = QUESTION_POOL.map((q) => q.id).filter(
