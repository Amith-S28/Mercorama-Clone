...
export function AdvisorNotesPanel({ assessmentId }: AdvisorNotesPanelProps) {
  ...
  return (
    <section className="bento-card" style={{ padding: "1.5rem" }}>
      ...
      <h3
        style={{ fontWeight: 300, fontSize: "1.25rem", marginBottom: "1rem" }}
      >
        Pillar Notes
      </h3>
      <div
      ...
      <p
        className="mono-label"
        style={{ color: "var(--text-tertiary)", marginTop: "0.75rem" }}
      >
        {loading ? "Loading notes…" : savedAt ? `Saved ${savedAt}` : "Saving…"}{" "}
