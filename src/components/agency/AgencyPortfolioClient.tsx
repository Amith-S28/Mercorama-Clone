...
export function AgencyPortfolioClient() {
  ...
  const { ref: activeClientsRef, value: activeClientsValue } =
    useGsapCounter<HTMLParagraphElement>({ end: smes.length });
  const { ref: avgScoreRef, value: avgScoreValue } =
    useGsapCounter<HTMLParagraphElement>({
      end: avgScore || 0,
      decimals: 1,
    });
    ...
    <div className="page-container">
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          >
            Manage SME export readiness assessments and track market
            intelligence across your advisory portfolio.
          </p>
        </div>
      </header>
        ...
        <>
          <div className="bento-grid" style={{ marginBottom: "2rem" }}>
            <div className="bento-card bento-card--span-6">
              ...
              >
                {assessments.length} completed assessment
            ...
            <div className="bento-card bento-card--span-6">
              ...
              <div className="progress-track" style={{ marginTop: "1rem" }}>
                <div
                  ...
                  style={{
                    width:
                      avgScore !== null ? `${Math.min(100, avgScore)}%` : "0%",
                  }}
                />
              </div>
            </div>
