...
export default async function PrintReportPage({
  ...
  const roadmapItems = assessment.aiReport?.actions.map((a) => a.task) ?? [
      ...
      <article className="print-report-page">
        ...
        >
          <div>
            ...
            <h1
              style={{ margin: "2mm 0 0", fontSize: "18pt", fontWeight: 700 }}
            >
              {sme.name}
            </h1>
            <p
        ...
        >
          <div
            ...
            style={
              { "--grade-color": gradeColor(assessment.grade) } as CSSProperties
            }
          >
          ...
          <div>
            <div style={{ fontSize: "28pt", fontWeight: 700, lineHeight: 1 }}>
              ...
              <span style={{ fontSize: "12pt", color: "var(--print-muted)" }}>
                %
              </span>
            </div>
            <p
        ...
        <div className="print-columns">
          <section className="print-card">
            <h2 style={{ margin: "0 0 4mm", fontSize: "11pt" }}>
              Pillar Scorecard
            </h2>
              ...
              <tbody>
                <tr>
                  ...
                  <td style={{ textAlign: "right" }}>
                    ${sme.productionCost.toFixed(2)}
                  </td>
                </tr>
                <tr>
                  <td>Unit freight (allocated)</td>
                  <td style={{ textAlign: "right" }}>
                    ${landed.unitFreightCost.toFixed(2)}
                  </td>
                </tr>
                <tr>
                  <td>Broker fee</td>
                  <td style={{ textAlign: "right" }}>
                    ${landed.brokerFee.toFixed(2)}
                  </td>
                </tr>
                <tr>
                  <td>Insurance fee</td>
                  <td style={{ textAlign: "right" }}>
                    ${landed.insuranceFee.toFixed(2)}
                  </td>
                </tr>
                <tr>
                  <td>Tariff per unit</td>
                  <td style={{ textAlign: "right" }}>
                    ${landed.tariffPerUnit.toFixed(2)}
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>Actual margin</td>
                  <td style={{ textAlign: "right" }}>
                    {landed.actualMargin.toFixed(1)}%
                  </td>
                </tr>
                <tr>
                  <td>FX buffer applied</td>
                  <td style={{ textAlign: "right" }}>
                    {landed.fxBufferUsed.toFixed(2)}%
                  </td>
                </tr>
                <tr>
                  <td>Currency-adjusted margin</td>
                  <td style={{ textAlign: "right" }}>
                    {landed.currencyAdjustedMargin.toFixed(1)}%
                  </td>
                </tr>
              </tbody>
            </table>
