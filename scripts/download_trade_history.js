 ...
 * 
 * Generates 10-year time-series trade indicators (2015-2024)
 ...
 * 
 * Usage: node scripts/download_trade_history.js
 */
...
function generateHistory() {
  ...
  for (const [iso3, meta] of Object.entries(COUNTRIES)) {
    ...
    const topImports = shuffledHs.slice(0, 6).map((ch, idx) => {
    ...
    const topExports = [...shuffledHs].reverse().slice(0, 6).map((ch, idx) => {
